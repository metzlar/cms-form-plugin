...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormPlugin.success_page'
        db.add_column(u'cmsplugin_formplugin', 'success_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormPlugin.success_page'
        db.delete_column(u'cmsplugin_formplugin', 'success_page_id')
    ...
    models = {
        ...
        u'cms_form_plugin.formplugin': {
            ...
            'success_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'sites.site': {
