...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FormPlugin.post_to_url'
        db.delete_column(u'cmsplugin_formplugin', 'post_to_url')


    def backwards(self, orm):
        # Adding field 'FormPlugin.post_to_url'
        db.add_column(u'cmsplugin_formplugin', 'post_to_url',
